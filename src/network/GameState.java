...
public class GameState implements Serializable{
	...
	public GameState(List<LevelInterface> inputLevels, LevelInterface currentLevel) {
		for(LevelInterface level : inputLevels){
	...
	private LevelState configure(LevelInterface level) {
		Map<String, Bundle<Actor>> actorMap = level.getController().getLevelConstructor()
				.getActorGroupsConstructor().getActorGroups().getMap();
		InteractionTreeNode rootTree = level.getController().getLevelConstructor()
				.getTreeConstructor().getRootTree();
